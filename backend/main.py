...
class DatePlanResponse(BaseModel):
    """
    Defines the output response model for the AI-generated date plan.
    """
    itinerary: str  # The structured itinerary generated by AI
...
def generate_ai_plan(places: list, preferences: DatePreferences) -> str:
    ...
    """
    prompt = f"""
    Given the following locations and constraints, generate an optimal date itinerary.
